...
export const SCENES: SceneData[] = [
  ...
  { id: 14, kind: 'print', rec: 'cadastro_visitante_passo_1', phrase: 'Cadastre o visitante', subtitle: 'Dados pessoais', durationSec: 1.8, scroll: false },
  ...
  { id: 21, kind: 'print', rec: 'gestor_de_visitantes', phrase: 'Gestor de visitantes', subtitle: 'Ativos e histórico', durationSec: 6.16, scroll: false },
  { id: 22, kind: 'print', rec: 'gestor_de_visitantes', phrase: 'Editar convites', subtitle: 'Reaproveitar convite', durationSec: 9.48, scroll: false },
