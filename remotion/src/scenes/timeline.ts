...
export const SCENES: SceneData[] = [
  ...
  { id: 7, kind: 'video', rec: 'videocameras', phrase: 'Alterne as câmeras', subtitle: 'Troque a visualização', durationSec: 6.78, scroll: false, videoStartSec: 7.66 },
  { id: 8, kind: 'video', rec: 'videocameras', phrase: 'Função que mais uso', subtitle: 'Com um toque', durationSec: 3.2, scroll: false, videoStartSec: 14.44 },
  { id: 9, kind: 'video', rec: 'videocameras', phrase: '1 toque', subtitle: 'Liberar acesso', durationSec: 10.68, scroll: false, videoStartSec: 17.64 },
  { id: 10, kind: 'video', rec: 'videocameras', phrase: 'Atenda pelo app', subtitle: 'Veja quem solicita', durationSec: 7.7, scroll: false, videoStartSec: 28.32 },
